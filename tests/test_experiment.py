...
def test_independent_agent_approval_authorizes_public_blind_measurement(tmp_path):
    ...
    assert "lower-level rendering engine" in task.instructions
    assert "complementary layers" in task.instructions
    assert "forensically dishonest" in task.instructions
